    ...
    >
      ...
      >
        ...
        <g id="chrome-screw-base" transform="translate(260, 480)">
          ...
          <path d="M 5 35 Q 110 50 215 35 L 215 65 Q 110 80 5 65 Z" fill="url(#chromeThread)" stroke="#000000" strokeWidth="1.5" />
          <path d="M 12 70 Q 110 85 208 70 L 208 100 Q 110 115 12 100 Z" fill="url(#chromeThread)" stroke="#000000" strokeWidth="1.5" />
          <path d="M 22 105 Q 110 120 198 105 L 198 135 Q 110 150 22 135 Z" fill="url(#chromeThread)" stroke="#000000" strokeWidth="1.5" />
          <path d="M 40 140 Q 110 155 180 140 L 170 165 Q 110 178 50 165 Z" fill="url(#chromeCap)" stroke="#000000" strokeWidth="1.5" />
        ...
        <g id="giant-tooth" transform="translate(190, 180)">
          <path
            d="M 175 315 C 130 315, 80 270, 65 210 C 50 145, 45 95, 85 45 C 120 5, 170 18, 195 48 C 220 18, 270 5, 305 45 C 345 95, 340 145, 325 210 C 310 270, 260 315, 215 315 Z"
            fill="url(#toothHighlight)"
            stroke="#ffffff"
            strokeWidth="2"
            strokeOpacity="0.8"
          />
          <path d="M 95 65 C 125 35, 160 40, 195 70 C 180 140, 130 190, 85 200 C 70 160, 75 110, 95 65 Z" fill="#ffffff" fillOpacity="0.4" />
          <path d="M 295 65 C 265 35, 230 40, 195 70 C 210 140, 260 190, 305 200 C 320 160, 315 110, 295 65 Z" fill="#cbd5e1" fillOpacity="0.3" />
          <path d="M 195 48 Q 195 110 195 170" stroke="#94a3b8" strokeWidth="4" strokeLinecap="round" strokeOpacity="0.5" />
          ...
          <path d="M 75 90 C 65 140, 70 190, 95 240" stroke="#ffffff" strokeWidth="6" strokeLinecap="round" fill="none" filter="url(#softGlow)" />
          <path d="M 315 90 C 325 140, 320 190, 295 240" stroke="#ffffff" strokeWidth="4" strokeLinecap="round" fill="none" opacity="0.8" />

          <g className={isSuperClean ? 'animate-pulse' : ''}>
            <path d="M 110 70 Q 195 140 180 280" stroke="#ffffff" strokeWidth="14" strokeLinecap="round" fill="none" strokeOpacity="0.35" filter="blur(5px)" />
          </g>
        ...
        <g id="worker-top-right" transform="translate(425, 110)">
          ...
          <g transform="translate(-45, 85)">
            <path d="M 0 0 L -85 55 L -95 30 Z" fill="url(#waterSpray)" filter="url(#softGlow)" />
