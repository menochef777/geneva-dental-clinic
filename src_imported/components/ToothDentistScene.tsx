...
export const ToothDentistScene: React.FC<ToothDentistSceneProps> = ({
  ...
  return (
    ...
    >
      {/* ========================================================================= */}
      {/* HIGH-FIDELITY PHOTOREALISTIC 3D CGI RENDER:                               */}
      {/* GLISTENING ENAMEL TOOTH + MACRO CONDENSATION WATER + SCISSOR LIFT & CREW  */}
      {/* ========================================================================= */}
        <svg
          viewBox="0 0 960 720"
        ...
        >
          <defs>
            {/* Ultra-Glossy 3D CGI Enamel Porcelain Gradient */}
            ...
            {/* Specular Glistening Surface Glaze (Left Cusp) */}
            ...
            {/* Specular Glistening Surface Glaze (Right Cusp) */}
            ...
            {/* Ambient Occlusion Crevice Shader */}
            ...
            {/* Deep Root Volumetric Gradients */}
            ...
            {/* Photorealistic Royal Blue Overalls Material */}
            ...
            {/* Steel / Chrome Scaffolding Material */}
            ...
            {/* Macro Water Droplet Material with Caustics & Reflection */}
          ...
          {/* ========================================================================= */}
          {/* 1. DARK WET REFLECTIVE GROUND FLOOR & CAUSTIC POOLS                       */}
          {/* ========================================================================= */}
          ...
          {/* Wet ground mirror reflections of the tooth roots */}
          ...
          {/* Water Puddle Ripples near base */}
          ...
          {/* ========================================================================= */}
          {/* 2. GIANT CENTRAL MOLAR TOOTH (CGI Anatomical Model + Enamel Texture)       */}
          {/* ========================================================================= */}
          <g id="cgi-central-tooth" transform="translate(480, 365)">
            {/* Outer Tooth Body Silhouette (Cusp Domes + 4 Anatomical Roots) */}
            <path
              d="M -190 -210
                 C -225 -120, -230 0, -210 95
                 C -198 155, -182 235, -160 290
                 C -148 314, -122 308, -110 278
                 C -92 225, -82 135, -65 85
                 C -55 60, -42 85, -30 135
                 C -14 205, 0 285, 20 304
                 C 30 314, 48 304, 55 278
                 C 68 225, 75 135, 88 85
                 C 98 60, 110 85, 118 135
                 C 134 210, 148 275, 168 288
                 C 180 298, 196 288, 198 258
                 C 206 195, 220 105, 225 10
                 C 230 -90, 225 -170, 185 -210
                 C 148 -260, 60 -270, 0 -230
                 C -60 -270, -152 -260, -190 -210
                 Z"
            ...
            {/* Occlusal Surface Sculpting (Crest & Cusp Curvatures) */}
            {/* Left Cusp Dome High-Gloss Reflection */}
            <path
              d="M -180 -200 C -140 -260, -50 -260, -15 -200 C -50 -140, -140 -140, -180 -200 Z"
              fill="url(#specularGlintLeft)"
            />
            {/* Right Cusp Dome Reflection */}
            <path
              d="M 15 -200 C 50 -260, 140 -260, 180 -200 C 140 -140, 50 -140, 15 -200 Z"
              fill="url(#specularGlintRight)"
            />

            {/* Central Occlusal Crevice Fissure (3D Anatomical Depth Groove) */}
            <path
              d="M 0 -230 Q 0 -150 0 -55 Q 0 35 0 85"
              stroke="#475569"
              strokeWidth="4.5"
              strokeLinecap="round"
              strokeOpacity="0.5"
            ...
            {/* Volumetric Root Shadow Interstices */}
            <path
              d="M -210 95 C -198 155, -182 235, -160 290 C -148 314, -122 308, -110 278 C -92 225, -82 135, -65 85"
              fill="url(#rootShaderLeft)"
              fillOpacity="0.65"
            />
            <path
              d="M -65 85 C -55 60, -42 85, -30 135 C -14 205, 0 285, 20 304 C 30 314, 48 304, 55 278 C 68 225, 75 135, 88 85"
              fill="url(#rootShaderLeft)"
              fillOpacity="0.75"
            />
            <path
              d="M 88 85 C 98 60, 110 85, 118 135 C 134 210, 148 275, 168 288 C 180 298, 196 288, 198 258 C 206 195, 220 105, 225 10"
              fill="url(#rootShaderRight)"
              fillOpacity="0.6"
            />

            {/* Major Specular Highlights & Glaze Radiance */}
            ...
            {/* Outer Rim Light Accents */}
            <path
              d="M -200 -140 C -215 -45, -208 55, -182 135"
              stroke="#ffffff"
              strokeWidth="7.5"
              strokeLinecap="round"
              fill="none"
            ...
            {/* ========================================================================= */}
            {/* MACROSCOPIC WATER DROPLETS & DRIPPING TRAILS ON ENAMEL                    */}
            {/* ========================================================================= */}
            <g id="water-macro-details">
              {/* Dripping Water Streams */}
              ...
              {/* Large Macro Water Droplets with Refraction */}
              ...
              {/* Dense Micro-Droplets Condensation Mesh */}
              {[
          ...
          {/* ========================================================================= */}
          {/* 3. LEFT INTRICATE MULTI-TIER METAL SCAFFOLDING PLATFORM                   */}
          {/* ========================================================================= */}
          <g id="left-industrial-scaffold" transform="translate(85, 340)">
            {/* Rolling Heavy-Duty Caster Wheels Base */}
            ...
            {/* Working Deck Platform Floor (Grip Mesh) */}
            ...
            {/* Upper Deck Safety Railings & Kickboards */}
          ...
          {/* ========================================================================= */}
          {/* 4. WORKER 1 (Top Scaffold Platform): Polishing Crown with Rotary Tool      */}
          {/* ========================================================================= */}
          <g id="worker-1-top-scaffold" transform="translate(225, 210)">
            ...
            {/* Arms Operating Rotary Polisher */}
            ...
            {/* Rotary Buffer Machine with Yellow Pad */}
            ...
            {/* High-Velocity Water Vapor & Splash Burst on Contact Point */}
          ...
          <g id="worker-2-top-scissor" transform="translate(745, 120)">
            ...
            {/* Royal Blue Overall Jacket (Dynamic Leaning Posture) */}
            ...
            {/* Arms Reaching Toward Tooth Cusp with Precision Tool */}
          ...
          {/* ========================================================================= */}
          {/* 6. RIGHT HYDRAULIC SCISSOR LIFT SYSTEM (Heavy Chrome Articulated Lift)    */}
          {/* ========================================================================= */}
          <g id="right-hydraulic-scissor-lift" transform="translate(735, 280)">
            {/* Rolling Caster Wheels Base */}
            ...
            {/* Articulated Scissor X-Braces Layer 1 (Bottom) */}
            ...
            {/* Articulated Scissor X-Braces Layer 2 (Middle) */}
            ...
            {/* Articulated Scissor X-Braces Layer 3 (Top) */}
          ...
          {/* ========================================================================= */}
          {/* 7. WORKER 3 (Bottom Right Ground): Polishing the Root Area                */}
          {/* ========================================================================= */}
          <g id="worker-3-bottom-right" transform="translate(665, 425)">
            {/* Work Boots on Ground */}
            ...
            {/* Arms Holding Angled Polisher against root */}
          ...
          {/* ========================================================================= */}
          {/* 8. WORKER 4 (Bottom Left by Ladder): Inspection & Hose Connection         */}
          {/* ========================================================================= */}
          ...
          {/* ========================================================================= */}
          {/* 9. LONG TRAILING HIGH-PRESSURE WATER HOSE                                  */}
          {/* ========================================================================= */}
          <g id="trailing-hose-network">
            {/* Top hose trailing gracefully across the scene */}
            <path
              d="M 745 180
                 C 810 240, 845 370, 845 480
                 C 845 610, 790 665, 710 675
                 C 630 682, 520 672, 430 680
                 C 340 686, 250 678, 190 672
                 C 145 668, 100 660, 75 630"
            ...
            />
            {/* Glossy Reflection Highlight Line along Hose */}
            <path
              d="M 745 180
                 C 810 240, 845 370, 845 480
                 C 845 610, 790 665, 710 675
